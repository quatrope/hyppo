...
class TestLegendreMomentExtractor:
    ...
    def test_legendre_moments_computation(self, small_hsi):
        """Test Legendre moments computation."""
        # Arrange: Create extractor and test patches
        extractor = LegendreMomentExtractor(max_order=2)
    ...
    def test_extract_moments_multiscale(self, small_hsi):
        ...
        extractor = LegendreMomentExtractor(window_sizes=[3, 5])
    ...
    def test_validate_invalid_window_size_values(
        ...
        extractor = LegendreMomentExtractor(window_sizes=[invalid_window])
    ...
    def test_feature_name(self):
        ...
        name = LegendreMomentExtractor.feature_name()

        # Assert: Verify correct name
        assert name == "legendre_moment"
    ...
    def test_multiscale_concatenation(self, small_hsi):
        ...
        window_sizes = [3, 5, 7]
        extractor = LegendreMomentExtractor(window_sizes=window_sizes)
