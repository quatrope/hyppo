# -*- coding: utf-8 -*-
#
# HYPPO documentation build configuration file, created by
...
# add the hyppo source to the build path
CURRENT_PATH = pathlib.Path(os.path.abspath(os.path.dirname(__file__)))
HYPPO_PATH = CURRENT_PATH.parent.parent

sys.path.insert(0, str(HYPPO_PATH))
    ...
    .. container:: binder-container
        ...
        .. nbinfo::
           ...
           .. image:: https://mybinder.org/badge_logo.svg
               :target: https://mybinder.org/v2/gh/quatrope/hyppo/{{ release }}?filepath={{ docname }}
...
texinfo_documents = [
    (
        ...
        author,
        "HYPPO",
        "A modular feature extractor for hyperspectral images.",
        "Miscellaneous",
    ),
]
