...
class FeatureSpace:
    ...
    def __init__(
        self,
        extractor_configs: Union[
            Dict[str, Tuple["Extractor", Dict[str, str]]], "Sequence[Extractor]"
        ],
    ):
        """
        ...
        if isinstance(extractor_configs, list):
            extractor_configs = self._from_list(extractor_configs)
    ...
    ) -> Dict[str, Tuple["Extractor", Dict[str, str]]]:
        """
